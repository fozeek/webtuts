<?php
	...
	Router::add("fr", "blog", "article", "/categorie-{category}/article-{article}.html");
	Router::add("fr", "blog", "categories", "/les-categories.html");
	Router::add("fr", "blog", "category", "/categorie-{category}.html");
	Router::add("fr", "blog", "actualites", "/les-actualites.html");
	Router::add("fr", "blog", "actualite", "/actualite-{news}.html");
	Router::add("fr", "blog", "tags", "/les-tags.html");
	Router::add("fr", "blog", "tag", "/tag-{tag}.html");
	...
	Router::add("fr", "page", "index", "/page-{page}.html");
	...
	Router::add("en", "blog", "article", "/category-{category}/article-{article}.html");
	Router::add("en", "blog", "categories", "/categories.html");
	Router::add("en", "blog", "category", "/category-{category}.html");
	Router::add("en", "blog", "actualites", "/news.html");
	Router::add("en", "blog", "actualite", "/news-{news}.html");
	Router::add("en", "blog", "tags", "/tags.html");
	Router::add("en", "blog", "tag", "/tag-{tag}.html");
	...
	Router::add("en", "page", "index", "/page-{page}.html");
